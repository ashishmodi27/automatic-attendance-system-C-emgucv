...
namespace MultiFaceRec {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmployeeID, string FullName, string PhoneNumber, string Email, string Address, byte[] Image, string status) {
...
namespace MultiFaceRec.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `status` IS NULL) OR (`status` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `FullName` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ?, `Image` = ?, `status` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `status` IS NULL) OR (`status` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiFaceRec.Properties.Settings.Default.mydbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FullName, PhoneNumber, Email, Address, [Image], status FROM Em" +
                "ployees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_status) {
        ...
        public virtual int Insert(string FullName, string PhoneNumber, string Email, string Address, byte[] Image, string status) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string PhoneNumber, string Email, string Address, byte[] Image, string status, int Original_EmployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_status) {
            if ((FullName == null)) {
